...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600&family=Roboto:ital,wght@0,300;0,400;1,300;1,400&display=swap" rel="stylesheet">
...
<body>
    ...
    <header class="container">
            <div id="top_header" class="container flex">
                <div class="header_left flex">
                    <img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="Google Logo" id="logo_menu">
                    <span>Privacy e termini</span>
                </div>
                <div class="header_right">
                </div>
            </div>
            <div id="header_submenu" class="container">
                <ul class="navigation_submenu menu_inline">
    ...
    <main>
        <div class="container_wrap">
            ...
            <?php
                ...
                // ciclo all'interno dell'array delle domande
                foreach ($faq_list as $question_block => $question_block_internal_key) {?>

                    <div class="question_block">

                        <!-- stampo testo domanda specificando la chiave all'interno del singolo elemento -->
                        <h2>
                            <?php echo $question_block_internal_key["question"];?>
                        </h2>

                        <!-- stampo testo risposta specificando la chiave all'interno del singolo elemento -->
                        <p>
                        <?php echo $question_block_internal_key["answer"];?>
                        </p>
                    </div>
